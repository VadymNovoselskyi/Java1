...
public class if_satser {
	...
	public static void main(String[] args) {
		...
		//if-satser stuyrs av logiska uttryck så kallade "villkor"		ett villkor kan antigen vara sant eller falskt
		...
		//decimaltal i ett interval: -2 < x < 3		flera villkor med "och"-&& eller "eller"-|| (altGr + <)
